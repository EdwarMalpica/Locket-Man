...
public class JTextAreaContainer extends JTextArea{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2874564245361332100L;
	 ...
	 * @param size tama�o que va a tener el textArea
	...
	public void chargeText(String pathText) {
		try {
			File file = new File(getClass().getResource(pathText).getPath());
	...
	/**
	 * a�ade el texto a este componente
