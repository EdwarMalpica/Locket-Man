...
public class Sounds {
    ...
    public void playSound(String sound, int wait) {
        try {
            ...
            AudioInputStream audioInputStream = AudioSystem.getAudioInputStream(new File( getClass().getResource(Constants.PATH_DIRECTORY_SOUNDS + sound + Constants.FORMAT_WAV).getPath()));
